...
if (isset($_SESSION['admin'])) {
  header("Location: dashboard.php");  // Cambiado a dashboard.php
  exit();
}
?>
  ...
  <div class="login-box">
    ...
    <form action="procesar_login.php" method="POST">
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="registro_admin.php" class="btn btn-register text-center">Registrar</a>
      </div>
    </form>
    ...
    <a href="login.php" class="btn-cliente">¿Eres cliente? Inicia sesión aquí</a>
